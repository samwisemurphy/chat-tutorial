...
{ 
 ...
 var currentColor = document.getElementById("colour").value; 
 ...
 "&colour=" + encodeURIComponent(currentColor) + 
...
{ 
 ...
 colorArray = response.getElementsByTagName("colour"); 
...
{ 
 ...
 var htmlMessage = ""; 
 htmlMessage += "<div class=\"item\" style=\"colour:" + colour + "\">"; 
...
{ 
 ...
 // change color 
 var oColor = document.getElementById("colour"); 
 var oSampleText = document.getElementById("sampleText"); 
